...
public class OjekOnlineRevisiSeriusBangetFINAL {
    ...
    private static double saldo_gopay = 0;
    private static double saldo_ovo = 0;
        ...
        while (isRunning) {
            ...
            switch (pilihan) {
                ...
                case "1":
                    ...
                    newLine();
                    status_saldo(saldo_gopay, saldo_ovo, df);
                    ...
                    while (salah) {
                        ...
                        if (metode.equals("gopay")) {
                            if (saldo_gopay < hargaTotal) {
                                ...
                                divider2();
                                System.out.printf("%-15s: %s\n", "From",
                                        asalPenumpang.toUpperCase() + " / "
                                                + asalPenumpang.substring(0, 3).toUpperCase());
                                System.out.printf("%-15s: %s\n", "To",
                                        tujuanPenumpang.toUpperCase() + " / "
                                                + tujuanPenumpang.substring(0, 3).toUpperCase());
                                divider2();
                                ...
                                newLine();
                                newLine();
                                saldo_gopay -= hargaTotal;
                            }
                        } else if (metode.equals("ovo")) {
                            if (saldo_ovo < hargaTotal) {
                                System.out.println("! SALDO ANDA TIDAK CUKUP !");
                            } else {
                                newLine();
                                System.out.printf("%43s\n", "OJEK TERBANG");
                            ...
                            divider2();
                            System.out.printf("%-15s: %s\n", "From",
                                    asalPenumpang.toUpperCase() + " / " + asalPenumpang.substring(0, 3).toUpperCase());
                            System.out.printf("%-15s: %s\n", "To",
                                    tujuanPenumpang.toUpperCase() + " / "
                                            + tujuanPenumpang.substring(0, 3).toUpperCase());
                            divider2();
                ...
                case "5":
                    ...
                    System.out.print("Pilih e-wallet: ");
                    int pilihan_Ewallet = than.nextInt();
                    than.nextLine();

                    switch (pilihan_Ewallet) {
                        case 1:
                            divider2();
                            System.out.print("Isi nominal top-up: ");
                            nominal = than.nextLong();
                            than.nextLine();
                            saldo_gopay += (double) nominal;
                            status_saldo(saldo_gopay, saldo_ovo, df);
                            newLine();
                            break;
    ...
    // Menampilkan Status Saldo
    public static void status_saldo(double saldo_gopay, double saldo_ovo, DecimalFormat df) {
        newLine();
        System.out.println("-------------- Status Saldo ---------------");
        System.out.printf("%-15s:%27s\n", "Gopay", df.format(saldo_gopay));
        System.out.printf("%-15s:%27s\n", "Ovo", df.format(saldo_ovo));
        divider2();
    }

    // Print Output + Saldo
    public static void printOutput_saldo(String metode, DecimalFormat df) {
        if (metode.equals("gopay")) {
            if (saldo_gopay < hargaTotal) {
                System.out.println("! SALDO ANDA TIDAK CUKUP !");
            } else {
