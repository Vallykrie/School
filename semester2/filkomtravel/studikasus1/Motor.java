 ...
 * 
 * This class extends the Vehicle class and provides additional functionality specific to Motor vehicles.
 */
public class Motor extends Vehicle {
    final String type = "Motor";

    /**
     * Constructs a new Motor object with the specified model, color, number plate, capacity, and price.
     * 
